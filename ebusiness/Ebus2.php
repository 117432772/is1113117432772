...
<ul>
  ...
  <li><a href="ebusiness/Ebus1.php">Products</a></li>
          	 ...
          	 <h2 style="color:rgb(255, 255, 255); font-family:serif">Please enter your payment details.</h2>
        
            <br />
            
            <form method = "POST" action = "Ebus3.php"> <!--pushes details to ebus3 for the receipt-->
                
                <label style="color:black;font-family:georgia;font-weight:bold;" for="user_pin">
                     PIN:
                </label>
                ...
                <br/>
                <br/>
                <label  style="color:black;font-family:georgia;font-weight:bold;" for="user_name">
                    Name:
                </label>
                ...
                <br/>
                <br/>
                <label  style="color:black;font-family:georgia;font-weight:bold;" for="user_email">
                    Email:
                </label>
     ...
     <footer> <!--creating link to ucc wesbite-->
      <br   />
